...
//Chance card Switch
        switch (ChanceCardNumber) {
            ...
            case 13:
                game.getGui().displayChanceCard("Move to the Skate Park ");
                game.setPlayer(player, 10);
                gameBoard.getFields()[player.getLocationIndex()].runAction(player, game);
                ChanceCardNumber++;
                break;
            ...
            case 14:
                game.getGui().displayChanceCard("Move to either the Candy Store, the Ice Cream Parlor, the Arcade   or the Cinema and if the field isn't owned you get it for free");
            ...
            case 15:
                game.getGui().displayChanceCard("Move to either the Burger Joint, the Pizzeria, the Toy Store  or the Pet Shop and if the field isn't owned you get it for free");
